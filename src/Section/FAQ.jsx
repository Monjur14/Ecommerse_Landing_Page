  ...
  return (
    <div className="contain mx-auto" id="faq">
      <div className="section__padding">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-center lg:gap-16 gap-8 md:gap-10 w-full border">
          <div className="lg:basis-3/4 space-y-2 border">
